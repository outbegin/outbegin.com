...
public class HttpClientUtil {
    ...
    public static void main(String[] args) throws Exception {
                ...
                config.url("https://test.xinyan.com/product/encrypt/archive/v3/overdue");
                Map<String, Object> params = new HashMap<>();
                params.put("member_id", "8150756923");
                params.put("terminal_id", "8150756923");
                params.put("data_type", "json");
                params.put("data_content", "123");
        ...
        private static HttpResponse execute(HttpConfig config) throws HttpProcessException {
                ...
                try {
                        ...
                        if(HttpEntityEnclosingRequestBase.class.isAssignableFrom(request.getClass())){
                                ...
                                String str2 = ArrayUtils.toString(config.headers(), ",");
                                System.out.println("config"+str2);
